...
git clone --depth 1 git@github.com:RaphaelIT7/GLuaTest.git _tmp_ssh &> /dev/null
git clone --depth 1 https://github.com/RaphaelIT7/GLuaTest.git _tmp_https &> /dev/null
